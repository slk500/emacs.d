...
;;(concat(file-name-directory buffer-file-name) "../Dropbox/phprefactor")
...
#+BEGIN_SRC emacs-lisp
;;(setq default-directory (concat (file-name-directory (buffer-file-name))))
   ...
   (eval `(defadvice ,command (after indent-region activate)
            (and (not current-prefix-arg)
                 (member major-mode '(emacs-lisp-mode lisp-mode
                                                      ...
                                                      plain-tex-mode clojurescript-mode))
...
#+BEGIN_SRC emacs-lisp
(global-set-key (kbd "M-0") 'xah-insert-paren) ; ()
