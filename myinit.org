...
* colview
#+begin_src elisp
;;(use-package org-colviewx :straight (:host github :repo "orgtre/org-colviewx"))
#+end_src
...
;;             (dired-do-revert-buffer wdt) Error (use-package): dired-filter/:catch: Symbol’s value as variable is void: wdt
