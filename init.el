...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eev debbugs centered-window bongo diredfl simpleclip dired-subtree
	 php-mode ivy-rich which-key counsel conunsel swiper
	 org-plus-contrib use-package))
 '(pulsar-pulse-functions
   '(smartscan-symbol-go-forward smartscan-symbol-go-backward
				 ...
				 previous-buffer windmove-right
				 windmove-left windmove-up
				 windmove-down
				 windmove-swap-states-right
				 windmove-swap-states-left
				 windmove-swap-states-up
				 windmove-swap-states-down tab-new
				 tab-close tab-next
